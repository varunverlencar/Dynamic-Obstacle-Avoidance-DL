...
csv_logger = CSVLogger('Results/Logs/1-drop-Aug-4HL-32-64-2FC-128_training.csv',separator = ',')
...
folder  = "Weights/"
ensure_dir(folder)
filepath= folder + "1-drop-Aug-4HL-32-64-2FC-128_weights.best.hdf5"
...
fileName = "1-drop-Aug-4HL-32-64-2FC-128_accuracy_val.png"
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='lower right')
fileName = "1-drop-Aug-4HL-32-64-2FC-128_loss.png"
plt.savefig(folder + fileName, bbox_inches='tight')
plt.close(fig)

folder  = "Results/Files/"
ensure_dir(folder)
with open(folder +"1-drop-Aug-Output_4HL-2FC1024.txt", "wb") as text_file:
